...
prerequisites exist (e.g., "generalize the base system" before new features).
...
- **Respect constraints.** Check CLAUDE.md for any project-specific
  constraints that apply to every sub-plan.
